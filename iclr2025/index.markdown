...
| 9:10–9:40     | Keynote 1 <br> "Towards Generative Foundation Models for Remote Sensing Data", Stefano Ermon            |
| 9:40–10:00    | Invited Talk 1  <br>  "GeoAI and Spatial Representation Learning for Rapid Disaster Response", Hao Li          |
| 10:00–10:30   | Coffee Break                     |
| 10:30–10:50   | Invited Talk 2  <br>"Machine Learning for Remote Sensing from a User's Perspective", Soo Chin Liew               |
| 10:50–11:20   | Oral Talks 1    <br> - A Recipe for Improving Remote Sensing VLM Zero Shot Generalization: [paper](camera_ready/papers/7.pdf) <br> - Using Multiple Input Modalities Can Improve Data-efficiency for ML with Satellite Imagery: [paper](camera_ready/papers/38.pdf), [poster](camera_ready/posters/38_poster.pdf) |
| 11:20–12:00   | Poster Session #1 <br> - Self-supervised Object Detection in Synthetic Aperture Radar Images: [paper](camera_ready/papers/2.pdf), [poster](camera_ready/posters/2_poster.pdf) <br> - Zero-Shot Tree Detection and Segmentation from Aerial Forest Imagery: [paper](camera_ready/papers/3.pdf) <br> - A Recipe for Improving Remote Sensing VLM Zero Shot Generalization: [paper](camera_ready/papers/7.pdf) <br> - Leveraging Satellite Imagery for Childhood Poverty Estimation: [paper](camera_ready/papers/8.pdf) <br> - Interactive Few-shot Online Adaptation for User-Guided Segmentation in Aerial Images: [paper](camera_ready/papers/9.pdf) <br> - PyViT-FUSE: A Foundation Model for Multi-Sensor Earth Observation Data: [paper](camera_ready/papers/10.pdf), [poster](camera_ready/posters/10_poster.jpg) <br> - Monitoring Illicit Rare Earth Mining in Myanmar via Self-Supervised Learning: [paper](camera_ready/papers/16.pdf) <br> - DR-SCAN: An Interpretable Dual-Branch Residual Spatial and Channel Attention Network for Remote Sensing and Geoscience Image Super-Resolution: [paper](camera_ready/papers/31.pdf) <br> - DEAL-YOLO: Drone-based Efficient Animal Localization using YOLO: [paper](camera_ready/papers/35.pdf) <br> - Using Multiple Input Modalities Can Improve Data-Efficiency for ML with Satellite Imagery: [paper](camera_ready/papers/38.pdf), [poster](camera_ready/posters/38_poster.pdf) <br> - Robustness to Geographic Distribution Shift using Location Encoders: [paper](camera_ready/papers/41.pdf) <br> - An Analysis of Multimodal Large Language Models for Object Localization in Earth Observation Imagery: [paper](camera_ready/papers/44.pdf), [poster](camera_ready/posters/44_poster.pdf) <br> - LIGHTHOUSE: Fast and Precise Distance to Shoreline Calculations from Anywhere on Earth: [paper](camera_ready/papers/47.pdf)  |
| 12:00–14:00   | Lunch Break                      |
| 14:00–14:30   | Keynote 2  <br> "ML4RS: Transforming Big Earth Data into Actionable Insights?", Xiaoxiang Zhu  |
| 14:30–15:00   | Oral Talks 2   <br> - Balancing Quantity and Representativeness in Constrained Geospatial Dataset Design: [paper](camera_ready/papers/43.pdf), [poster](camera_ready/posters/43_poster.pdf) <br> - Do Satellite Tasks Need Special Pretraining?: [paper](camera_ready/papers/58.pdf)       |
| 15:00–15:30   | Coffee Break                     |
| 15:30–15:50   | Invited Talk 3  <br> "Earth Embeddings: A new perspective on geospatial foundation models", Konstantin Klemmer           |
| 15:50–16:20   | Oral Talks 3  <br> - Tackling Few-Shot Segmentation in Remote Sensing via Inpainting Diffusion Model: [paper](camera_ready/papers/18.pdf) <br> - OSDMamba: Enhancing Oil Spill Detection from Synthetic Aperture Radar Images Using Selective State Space Model: [paper](camera_ready/papers/30.pdf)        |
| 16:20–17:00   | Poster Session 2 <br> - Onboard Terrain Classification via Stacked Intelligent Metasurface-Diffractive Deep Neural Networks from SAR Level-0 Raw Data: [paper](camera_ready/papers/5.pdf) <br> - Tackling Few-Shot Segmentation in Remote Sensing via Inpainting Diffusion Model: [paper](camera_ready/papers/18.pdf) <br> - Metadata, Wavelet, and Time Aware Diffusion Models for Satellite Image Super Resolution: [paper](camera_ready/papers/19.pdf), [poster](camera_ready/posters/19_poster.pdf) <br> - Assessing SAM for Tree Crown Instance Segmentation from Drone Imagery: [paper](camera_ready/papers/20.pdf), [poster](camera_ready/posters/20_poster.pdf) <br> - LandsatQuake: A Large-Scale Dataset for Practical Landslide Detection: [paper](camera_ready/papers/23.pdf) <br> - OSDMamba: Enhancing Oil Spill Detection from Synthetic Aperture Radar Images Using Selective State Space Model: [paper](camera_ready/papers/30.pdf) <br> - Efficient Land-Cover Image Classification via Mixed Bit-Precision Quantization: [paper](camera_ready/papers/32.pdf) <br> - Predicting Out-of-Domain Performance under Geographic Distribution Shifts: [paper](camera_ready/papers/33.pdf), [poster](camera_ready/posters/33_poster.pdf) <br> - Balancing Quantity and Representativeness in Constrained Geospatial Dataset Design: [paper](camera_ready/papers/43.pdf), [poster](camera_ready/posters/43_poster.pdf) <br> - SAMSelect: A Spectral Index Search for Marine Debris Visualization Using Segment Anything: [paper](camera_ready/papers/50.pdf), [poster](camera_ready/posters/50_poster.pdf) <br> - Self-Supervised Representation Learning on Remote Sensing Pixel Time Series with Patch-Based Masking: [paper](camera_ready/papers/52.pdf) <br> - Large Language Models for Captioning and Retrieving Remote Sensing Images: [paper](camera_ready/papers/53.pdf), [poster](camera_ready/posters/53_poster.pdf) <br> - Do Satellite Tasks Need Special Pretraining?: [paper](camera_ready/papers/58.pdf) |
